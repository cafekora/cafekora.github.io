...
<div class="row">
<div class="large-4 columns">
        <img src="{{ site.urlimg }}BaniLessonStaff2.png" alt="Bani Staff Notation" width="300" height="225" border="5">
        <p>Bani Le - Staff Notation v2</p>
</div>
<div class="large-4 columns">
        <img src="{{ site.urlimg }}BaniLessonTab2.jpg" alt="Bani Tab" width="300" height="225" border="5">
        <p>Bani Le - Tab v2</p>
</div>
<div class="large-4 columns">
        <img src="{{ site.urlimg }}BaniLessonBridge2.jpg" alt="Bani Bridge" width="300" height="225" border="5">
...
<div class="row">
<div class="large-4 columns">
        <img src="{{ site.urlimg }}BaniLessonStaff3.png" alt="Bani Staff Notation" width="300" height="225" border="5">
        <p>Bani Le - Staff Notation v3</p>
</div>
<div class="large-4 columns">
        <img src="{{ site.urlimg }}BaniLessonTab3.jpg" alt="Bani Tab" width="300" height="225" border="5">
        <p>Bani Le - Tab v3</p>
</div>
<div class="large-4 columns">
        <img src="{{ site.urlimg }}BaniLessonBridge3.jpg" alt="Bani Bridge" width="300" height="225" border="5">
...
<div class="row">
<div class="large-4 columns">
        <img src="{{ site.urlimg }}BaniLessonStaff4.png" alt="Bani Staff Notation" width="300" height="225" border="5">
        <p>Bani Le - Staff Notation v4</p>
</div>
<div class="large-4 columns">
        <img src="{{ site.urlimg }}BaniLessonTab4.jpg" alt="Bani Tab" width="300" height="225" border="5">
        <p>Bani Le - Tab v4</p>
</div>
<div class="large-4 columns">
        <img src="{{ site.urlimg }}BaniLessonBridge4.jpg" alt="Bani Bridge" width="300" height="225" border="5">
...
<div class="row">
<div class="large-4 columns">
        <img src="{{ site.urlimg }}BaniLessonStaff5.png" alt="Bani Staff Notation" width="300" height="225" border="5">
        <p>Bani Le - Staff Notation v5</p>
</div>
<div class="large-4 columns">
        <img src="{{ site.urlimg }}BaniLessonTab5.jpg" alt="Bani Tab" width="300" height="225" border="5">
        <p>Bani Le - Tab v5</p>
</div>
<div class="large-4 columns">
        <img src="{{ site.urlimg }}BaniLessonBridge5.jpg" alt="Bani Bridge" width="300" height="225" border="5">
